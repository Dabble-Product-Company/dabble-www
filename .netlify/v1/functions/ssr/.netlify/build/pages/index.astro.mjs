/* empty css                                 */
import { a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent } from '../chunks/astro/server_CQoEOmdl.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Container, b as $$Link, a as $$Base, s as settings } from '../chunks/Container_Bdva7whs.mjs';
import 'clsx';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Base, { "seo": seo }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="relative flex flex-col w-full space-y-8 md:space-y-12"> <div class="flex flex-col w-full gap-4 m-0 mb-8"> ${renderComponent($$result3, "Logo", $$Logo, {})} </div> <h1 class="w-full m-auto text-5xl tracking-tight font-display leading-tighter md:leading-tighter md:text-7xl">For the creative<br> in all of us</h1> <article class="prose-base"> <p>${renderComponent($$result3, "Link", $$Link, { "href": "/" }, { "default": ($$result4) => renderTemplate`${title}` })} is a product studio building experiences that inspire, empower, and amplify creative expression.</p> <p>Our mission is to make it easier for everyone to pursue their interests — whether you're a beginner, a professional, or you just like to dabble.</p> </article> <hr class="border"> <article class="space-y-4"> <h4 class="p-0 m-0 text-sm">Coming Soon</h4> <p>🧵 ${renderComponent($$result3, "Link", $$Link, { "href": "https://bobbin.app", "external": true }, { "default": ($$result4) => renderTemplate`Bobbin` })}: a mobile app for sewists</p> </article> </div> ` })} ` })}`;
